// FONTE ÚNICA de verificação de JWT e resolução de identidade.
// -----------------------------------------------------------------------------
// Mesma lógica que cada function carregava em cópia própria (ver ARQUITETURA_
// AUTH.md §2 — hoje desatualizado: base44/shared resolve em runtime). Quem
// precisar de identidade importa daqui; não copia mais.
//
// Contrato:
//   resolveIdentity(req, base44) → { email, role, source } | null
//   - JWT próprio (googleSignIn/appleSignIn): role SEMPRE 'user', nunca admin.
//   - Sessão Base44: role da sessão.
//   - Nenhum dos dois: null (=> 401 em quem chama).
...
export async function resolveIdentity(req, base44) {
