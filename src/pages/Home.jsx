    ...
    <div className="min-h-screen bg-[#0D3B66]">
      ...
      <header className="bg-[#0D3B66] border-b border-blue-800 sticky top-0 z-40">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src="https://media.base44.com/images/public/68e28688c6f4ec5cd17e317d/f6e090428_ecgzinho.png" alt="PlayECG" className="w-9 h-9 rounded-xl shadow-md" />
      ...
      <footer className="py-8 px-6 text-center text-blue-300 text-sm border-t border-blue-800 bg-[#0D3B66]">
        <div className="flex items-center justify-center gap-2 mb-2">
          <img src="https://media.base44.com/images/public/68e28688c6f4ec5cd17e317d/f6e090428_ecgzinho.png" alt="PlayECG" className="w-5 h-5 rounded" />
