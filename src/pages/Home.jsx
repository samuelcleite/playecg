...
export default function Home() {
  ...
  return (
    ...
    <div className="md:hidden min-h-screen bg-[#0D3B66] flex flex-col justify-center px-6 py-10" style={{ paddingTop: 'calc(2.5rem + var(--app-safe-top-fluxo, 0px))', paddingBottom: 'calc(2.5rem + env(safe-area-inset-bottom, 0px))' }}>
